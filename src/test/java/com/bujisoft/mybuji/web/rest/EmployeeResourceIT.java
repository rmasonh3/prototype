...
import com.bujisoft.mybuji.domain.User;
import com.bujisoft.mybuji.domain.WorkRequest;
import com.bujisoft.mybuji.domain.enumeration.Department;
import com.bujisoft.mybuji.domain.enumeration.Role;
...
import com.bujisoft.mybuji.service.EmployeeService;
...
class EmployeeResourceIT {
    ...
    private static final Department DEFAULT_DEPARTMENT = Department.SSD;
    private static final Department UPDATED_DEPARTMENT = Department.PGBA_Client;

    private static final Role DEFAULT_ROLE = Role.Admin;
    private static final Role UPDATED_ROLE = Role.Project_Owner;
    ...
    public static Employee createEntity(EntityManager em) {
        ...
        employee.setWorkrequest(workRequest);
        return employee;
    }
    ...
    void putExistingEmployee() throws Exception {
        ...
        await()
            ...
            .untilAsserted(() -> {
                ...
                assertThat(testEmployeeSearch.getEmployeeId()).isEqualTo(UPDATED_EMPLOYEE_ID);
                ...
                assertThat(testEmployeeSearch.getPhone()).isEqualTo(UPDATED_PHONE);
                assertThat(testEmployeeSearch.getDepartment()).isEqualTo(UPDATED_DEPARTMENT);
                assertThat(testEmployeeSearch.getRole()).isEqualTo(UPDATED_ROLE);
            });
    }
    ...
    void partialUpdateEmployeeWithPatch() throws Exception {
        ...
        partialUpdatedEmployee.phone(UPDATED_PHONE);
