...
describe('WorkRequest Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'work-request', component: WorkRequestComponent }]), HttpClientTestingModule],
  ...
  it('Should call load all on init', () => {
    ...
    expect(comp.workRequests?.[0]).toEqual(expect.objectContaining({ id: 123 }));
  });

  describe('trackId', () => {
    it('Should forward to workRequestService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getWorkRequestIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getWorkRequestIdentifier).toHaveBeenCalledWith(entity);
